...
public class APIUserController extends APIController {
    ...
    /** constant for billing staff role */
    private static final String       ROLE_BILLINGSTAFF     = "ROLE_BILLINGSTAFF";
    ...
    private static final List<String> ALL_ROLES       = List.of( ROLE_ADMIN, ROLE_PATIENT, ROLE_HCP, ROLE_ER,
            ROLE_LABTECH, ROLE_VIROLOGIST, ROLE_OD, ROLE_OPH, ROLE_VACCINATOR, ROLE_BILLINGSTAFF );
