...
public class OfficeVisitForm implements Serializable {
    ...
    /**
     * The cpt codes associated with the visit
     *
     */
    ...
    public OfficeVisitForm ( final OfficeVisit ov ) {
        ...
        System.out.println( ov.getCptCodes() );
        System.out.println( "OFFICEVISITFORM" );
    ...
    /**
     * Sets the OfficeVisitForm's CPTCodes param the List of CPTCodes
     */
