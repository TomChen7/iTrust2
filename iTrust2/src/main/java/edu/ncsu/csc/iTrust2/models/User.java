...
public class User extends DomainObject {
    ...
    public void setRoles ( final Set<Role> roles ) {
        ...
        } else if ( roles.contains( Role.ROLE_BILLINGSTAFF ) && roles.contains( Role.ROLE_HCP ) ) {
            throw new IllegalArgumentException(
                    "Tried to create a Billing staff user with a HCP role.  Billing staff can not be a HCP!" );
        }
