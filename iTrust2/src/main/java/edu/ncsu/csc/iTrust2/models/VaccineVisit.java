...
public class VaccineVisit extends DomainObject {
    ...
    /**
     * Adds a CPTCode to the vaccine visit
     *
     * @param c
     */
    public void addCPTCode ( final CPTCode c ) {
        validateCPTCode( c );
        if ( cptCodes == null ) {
            cptCodes = new ArrayList<CPTCode>();
        }
        cptCodes.add( c );
    }
    ...
    /**
     * Ensures a CPTCode is valid
     *
     * @param code
     *            code to check validity of
     * @throws IllegalArgumentException
     *             if the code is invalid
     */
    private void validateCPTCode ( final CPTCode code ) {

        /*
         * final List<CPTCode> validCodes = codeService.getCodes(); boolean
         * foundMatch = false; for ( final CPTCode v : validCodes ) { if (
         * v.equals( code ) ) { foundMatch = true; break; } } if ( !foundMatch )
         * { throw new IllegalArgumentException( "Invalid CPT Code" ); }
         */
    }
