...
public enum TransactionType {
    ...
    /**
     * Billing staff created a new CPT code
     */
    CPTCODE_CREATE ( 2000, "Billing staff created a new CPT code", true ),
    /**
     * Billing staff edited an existing drug
     */
    CPTCODE_EDIT ( 2001, "Billing staff edited an existing drug", true ),
    /**
     * /** Billing staff deleted an existing drug
     */
    CPTCODE_DELETE ( 2002, "Billing staff deleted an existing drug", true ),
    /**
     * User views all CPT codes in the system
     */
    CPTCODE_VIEW ( 2003, "User views all CPT codes in the system", true ),
    /**
     * User views a CPT code in the system
     */
    CPTCODE_GET ( 2004, "User views a CPT code in the system", true ),
	
	/**
	 * HCP creates a bill
	 */
	BILL_CREATE (2101, "HCP creates bill", true),
	
	/**
	 * Billing staff edited an existing bill
	 */
	BILL_EDIT (2102, "Billing Staff edited an existing bill", true),
	
	/**
	 * User views a bill in the system
	 */
	BILL_GET (2103, "User views a Bill", true),
	
	/**
	 * Patient views all their bills
	 */
	BILL_VIEW_PATIENT (2104, "All existing bills for a specific patient were viewed", true),
	
	/**
	 * Billing staff views all bills in the system
	 */
	BILL_VIEW (2105, "Billing staff views all existing bills", true);
